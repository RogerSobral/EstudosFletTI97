                ...
                content=Column(
                    controls=[
                        Container(padding=padding.only(bottom=10),
                            content=Image(src="lanche2.png")),
                        Container(
                            padding=padding.only(bottom=10),
                            content=Row(controls=[Text("Título", size=20, color=colors.BLACK, weight=FontWeight.BOLD)],
                            alignment=MainAxisAlignment.CENTER))
                        , # aqui é a linha que trabalha com o título
                        Row(controls=[Column(
                            spacing=1,
                                            controls=[
                                                Text(f"Loja {i}",size=13,weight=FontWeight.BOLD),
                                                Text("Lanches", size=10, color=colors.BLACK),
                                                Row(controls=[
                                                    Icon(icons.CIRCLE, color=colors.GREEN_300, size=10),
                                                    Text("Aberto", size=10)
                                                            ] )
                                                    ]
                                     ...
                                     Column(controls=[
                                                    Text("de R$ 45,90 por:", size=14,weight=FontWeight.BOLD),
                                                    Text("R$ 27,00", size=20, color=colors.GREEN_300)
                    ...
                    Row(controls=[Container(
                        expand=True,
                        content=ElevatedButton(text="Pedir Agora",color=colors.WHITE,
