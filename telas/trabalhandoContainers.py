...
def main(page:Page):
    ...
    modal=Container(
        ...
        content=Column(
            controls=[
                Row(controls=[
                    Image(src="imgLogin.png")
                ], alignment=MainAxisAlignment.CENTER),
                Row(
                    controls=[
                        Container(content=Text("Titulo1", size=20, weight=FontWeight.BOLD),border=border.only(
                            bottom=BorderSide(1,color=colors.BLUE_GREY_300)))
                ...
                Row(
                    controls=[
                        Text(
                            "srrrsrsrrsrsrsrsrrssrsrsrsrrsrsrrsssssssssssssssssssssssssssssssssssssssssssssssssssssss"
                            "",max_lines=3, width=200, text_align=TextAlign.JUSTIFY)
                    ]
                )
